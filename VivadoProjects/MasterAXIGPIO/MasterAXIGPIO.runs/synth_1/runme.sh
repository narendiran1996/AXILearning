...
HD_PWD='/home/narendiran/Desktop/AXILearning/VivadoProjects/MasterAXIGPIO/MasterAXIGPIO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BlkGPIO_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BlkGPIO_wrapper.tcl
