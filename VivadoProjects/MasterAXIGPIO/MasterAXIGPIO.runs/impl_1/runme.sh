...
HD_PWD='/home/narendiran/Desktop/AXILearning/VivadoProjects/MasterAXIGPIO/MasterAXIGPIO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BlkGPIO_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BlkGPIO_wrapper.tcl -notrace
