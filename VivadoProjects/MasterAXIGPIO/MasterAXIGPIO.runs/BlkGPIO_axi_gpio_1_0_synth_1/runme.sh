...
HD_PWD='/home/narendiran/Desktop/AXILearning/VivadoProjects/MasterAXIGPIO/MasterAXIGPIO.runs/BlkGPIO_axi_gpio_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BlkGPIO_axi_gpio_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BlkGPIO_axi_gpio_1_0.tcl
